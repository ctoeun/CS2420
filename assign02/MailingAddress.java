...
public class MailingAddress {
	...
	/**
	 * Two mailing addresses are considered equal if they have the same street,
	 * city, state, and zip code.
	 * 
	 * @param other - the object being compared with this mailing address
	 * @return true if the other object is a MailingAddress type and is equal to
	 *         this mailing address, false otherwise
	 */
	public boolean equals(Object other) {
		...
		return lhs.street.equals(rhs.street) && lhs.city.equals(rhs.city) && lhs.state.equals(rhs.state)
