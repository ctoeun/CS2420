...
public class CS2420Class {
	...
	public boolean addStudent(CS2420Student student) {
		for (CS2420Student studentToCheck : this.studentList) {
	...
	public ArrayList<CS2420Student> lookup(EmailAddress contactInfo) {
		ArrayList<CS2420Student> studentList = new ArrayList<CS2420Student>();
		for (CS2420Student studentToCheck : this.studentList) {
	...
	public void addScore(int uNID, double score, String category) {
		CS2420Student studentToAdd = this.lookup(uNID);
	...
	public double computeClassAverage() {
		...
		// Check if no students are in the collection
	...
	public ArrayList<EmailAddress> getContactList() {
		ArrayList<EmailAddress> contactInfo = new ArrayList<EmailAddress>();
		checkLoop: for (CS2420Student studentToCheck : this.studentList) {
			for (EmailAddress email : contactInfo) {
				if (studentToCheck.getContactInfo().equals(email)) {
					continue checkLoop;
				}
			}
