...
public class EmailAddress {
	...
	/**
	 * Two email addresses are considered equal if they have the same user name and
	 * domain name.
	 * 
	 * @param other - the object being compared with this email address
	 * @return true if the other object is an EmailAddress type and is equal to this
