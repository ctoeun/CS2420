 ...
 * @param <V> - the value
 */
public class HashTable1<K, V> implements Map<K, V> {
	 ...
	 */
	public int putCollisions(K key, V value) {
		// get index
		int index = hashFunction(key);
		// put the value into the array
		LinkedList<MapEntry<K, V>> tempEntry = this.entryArray.get(index);
	...
	private void extendMap() {
		...
		// initialize the new entryArray with doubled size and all null, set
		// this.entryArray to new entryArray
